...
<html>
    ...
    <body>
        ...
        <jsp:include page="../jspSegments/navbar.jsp"></jsp:include>
            <div class="container">
                <h1 class="text-center mt-3">Update Account</h1>
                <form action="/account?action=update&account=${account.getAccount()}" method="post" class="create-product-form" id="create-product-form">
                ...
                <c:choose>
                    <c:when test="${sessionScope.account.getRoleInSystem() == 1}">
                        ...
                        <div class="is-form-group form-group mb-3">
                            ...
                            <select class="form-select is-form-control form-control shadow-none" id="isUse" name="isUse">
                                ...
                                <option value="0" <c:if test="${!account.isIsUse()}">selected</c:if>>Prevented</option>
                                </select>
                            </div>
                    ...
                    <c:when test="${session.account.getRoleInSystem() != 1}">
                        <input type="hidden" name="isUse" id="isUse" value="${account.isIsUse() ? 1 : 0}"/>
                        <input type="hidden" name="roleInSystem" id="roleInSystem" value="${account.getRoleInSystem()}"/>
                    </c:when>
                </c:choose>
